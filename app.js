...
function renderClientCard(client, index, total) {
  ...
  if (client.telefono1 || client.telefono2) {
    btnLlamar += client.telefono1 ? `<a href="tel:${esc(client.telefono1)}" class="btn-maps" style="background:var(--primary-dark); flex: 0.8 !important;" title="Llamar Tel 1">${phoneSvg} 1</a>` : '';
    btnLlamar += client.telefono2 ? `<a href="tel:${esc(client.telefono2)}" class="btn-maps" style="background:var(--primary-dark); flex: 0.8 !important;" title="Llamar Tel 2">${phoneSvg} 2</a>` : '';
  }
...
function renderSearchResults(results, query) {
  ...
  container.innerHTML = results.map((client, i) => {
    ...
    let btnLlamar = '';
    if (client.telefono1 || client.telefono2) {
      btnLlamar += client.telefono1 ? `<a href="tel:${esc(client.telefono1)}" class="btn-maps btn-maps-sm" style="background:var(--primary-dark); flex: 0.8 !important;" title="Llamar Tel 1">${phoneSvg} 1</a>` : '';
      btnLlamar += client.telefono2 ? `<a href="tel:${esc(client.telefono2)}" class="btn-maps btn-maps-sm" style="background:var(--primary-dark); flex: 0.8 !important;" title="Llamar Tel 2">${phoneSvg} 2</a>` : '';
    }
